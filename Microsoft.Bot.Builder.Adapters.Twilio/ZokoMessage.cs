...
namespace Microsoft.Bot.Builder.Adapters.TwilioWhatsapp
{
    ...
    public class ZokoMessage
    {
        ...
        public string PlatformRecieverId { get; set; }
        public string PlatformSenderId { get; set; }
        public DateTime PlatformTimestamp { get; set; }
        public string SenderName { get; set; }
        public string Text { get; set; }
        public string Type { get; set; } // text, document, location
